...
export function ShareButton({ title, text, url, magnitude, place }: ShareButtonProps) {
      ...
      {showOptions && (
        <>
          ...
          <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-900 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 z-50 py-2">
            ...
            <button
              onClick={() => { shareToTwitter(); setShowOptions(false); }}
              className="w-full flex items-center gap-2 px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800"
            >
            ...
            <button
              onClick={() => { shareToFacebook(); setShowOptions(false); }}
              className="w-full flex items-center gap-2 px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800"
            >
            ...
            <button
              onClick={() => { shareToWhatsApp(); setShowOptions(false); }}
              className="w-full flex items-center gap-2 px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800"
            >
            ...
            <button
              onClick={() => { shareToTelegram(); setShowOptions(false); }}
              className="w-full flex items-center gap-2 px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800"
            >
